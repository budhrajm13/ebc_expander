class CommentAnalyzer {
    constructor() {
        this.testableCategories = {
            wrong_item: {
                phrases: ['wrong item', 'incorrect item', 'not what i ordered', 'different from ordered', 'wrong product', 'size is wrong'],
                confidence: 0.9
            },
            compatibility_issue: {
            ...
            material_difference: {
                phrases: ['materially different', 'not as described', 'different material', 'different color', 'not as pictured', 'not as shown', 'style not as expected', 'not as per description.'],
                confidence: 0.8
            },
            used_item: {
                phrases: ['used item', 'pre-owned', 'previously used', 'not new', 'opened before', 'signs of use', 'used product'],
                confidence: 0.95
            },
        };
